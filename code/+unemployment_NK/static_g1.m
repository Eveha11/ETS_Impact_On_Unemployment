...
g1 = zeros(34, 34);
g1(1,2)=(-(y(29)*getPowerDeriv(y(2),(-params(4)),1)));
g1(1,9)=1;
g1(1,29)=(-T(1));
g1(2,1)=params(1);
g1(3,5)=(-1);
...
g1(5,6)=1;
g1(5,7)=(-(T(4)*params(26)*y(27)*getPowerDeriv(y(7),params(3),1)));
g1(5,27)=(-(T(4)*params(26)*T(2)));
g1(6,7)=(-(1-(1-params(2))));
g1(6,8)=y(31);
g1(6,31)=y(8);
g1(7,1)=(-y(13));
...
g1(8,13)=y(31)-(1+(-y(8))/y(8))*y(31)*params(15)/2;
g1(8,31)=y(13)-(1+(-y(8))/y(8))*params(15)/2*y(13);
...
g1(12,15)=1-y(30)*params(12);
g1(12,16)=(-(y(30)*params(12)));
g1(12,30)=y(15)*(-params(12))-y(16)*params(12);
...
g1(17,12)=(-(1/y(11)));
g1(18,6)=(-(y(34)*params(22)*(1-y(18))*T(15)));
g1(18,17)=1;
g1(18,18)=(-(y(34)*T(6)*(-params(22))));
g1(18,34)=(-(T(6)*params(22)*(1-y(18))));
g1(19,6)=(-(y(32)*T(9)*T(11)*((y(6))-y(6))/((y(6))*(y(6)))*getPowerDeriv(y(6)/(y(6)),params(17),1)*T(17)));
g1(19,11)=(-(y(32)*T(9)*T(17)*T(12)*(y(12))*((y(11))-y(11))/((y(11))*(y(11)))*getPowerDeriv(y(11)/(y(11)),params(18),1)));
g1(19,12)=1-y(32)*(T(14)*getPowerDeriv(y(12),params(16),1)+T(9)*T(17)*T(10)*T(12));
g1(19,32)=(-(T(9)*T(14)));
g1(20,6)=(-(params(9)*y(28)));
g1(20,19)=1;
g1(20,28)=(-((y(6))*params(9)));
g1(21,20)=1;
g1(21,33)=(-params(20));
g1(22,22)=1;
g1(23,23)=1;
...
g1(25,25)=1;
g1(26,26)=1;
g1(27,27)=1/y(27)-params(28)*1/y(27);
g1(28,28)=1/y(28)-params(29)*1/y(28);
g1(29,29)=1/y(29)-params(30)*1/y(29);
g1(30,31)=1/y(31)-params(32)*1/y(31);
g1(31,30)=1/y(30)-params(31)*1/y(30);
g1(32,32)=1/y(32)-params(33)*1/y(32);
