...
residual = zeros(34, 1);
    ...
    residual(6) = (y(8)*y(31)) - (y(7)-y(7)*(1-params(2)));
    residual(7) = ((1-params(2))*y(13)+y(6)*params(3)*y(21)/y(7)) - (y(1)*y(13));
    residual(8) = (y(31)*y(13)) - (1+params(15)/2*y(31)*y(13)*(1+(-y(8))/y(8)));
...
residual(11) = 1-params(14)+params(14)*y(10)-params(19)*y(11)*(y(11)-(y(11)))+(y(11)-(y(11)))*y(11)*params(1)*params(19);
    residual(12) = (y(15)*(1-y(30)*params(12))) - (y(16)*y(30)*params(12));
    ...
    residual(18) = (y(17)) - (T(6)*params(22)*(1-y(18))*y(34));
    residual(19) = (y(12)) - (T(9)*T(14)*y(32));
    residual(20) = (y(19)) - ((y(6))*params(9)*y(28));
    residual(21) = (y(20)) - (params(20)*y(33));
residual(22) = y(22);
    residual(23) = (y(23)) - (y(11)-(y(11)));
residual(24) = y(24);
residual(25) = y(25);
residual(26) = y(26);
    residual(27) = (log(y(27))) - (log(y(27))*params(28)+x(1));
    residual(28) = (log(y(28))) - (log(y(28))*params(29)+x(2));
    residual(29) = (log(y(29))) - (log(y(29))*params(30)+x(3));
    residual(30) = (log(y(31))) - (log(y(31))*params(32)+x(5));
    residual(31) = (log(y(30))) - (log(y(30))*params(31)+x(4));
    residual(32) = (log(y(32))) - (log(y(32))*params(33)+x(6));
    residual(33) = (log(y(33))) - (log(y(33))*params(34)+x(7));
    residual(34) = (log(y(34))) - (log(y(34))*params(35)+x(8));
