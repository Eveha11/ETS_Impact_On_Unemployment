...
residual(11) = 1-params(14)+params(14)*y(10)-params(19)*y(11)*(y(11)-(y(11)))+(y(11)-(y(11)))*y(11)*params(1)*params(19);
    ...
    residual(13) = (y(28)) - (y(10)-params(23)*y(18)^params(24)-y(20)*(1-params(25))*params(22)*(1-y(18))*T(5));
    ...
    residual(18) = (y(17)) - (T(6)*params(22)*(1-y(18))*y(36));
    residual(19) = (y(12)) - (T(9)*T(14)*y(34));
    residual(20) = (y(19)) - ((y(6))*params(9)*y(30));
    residual(21) = (y(20)) - (params(20)*y(35));
residual(22) = y(21);
residual(23) = y(22);
residual(24) = y(23);
...
residual(28) = y(27);
    ...
    residual(36) = (log(y(36))) - (log(y(36))*params(35)+x(8));
